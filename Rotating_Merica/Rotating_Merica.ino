...
void loop()  { 
  ...
  registerWrite(5, OFF, color3, MID);
  ...
  registerWrite(5, ON, color3, BOT);
  registerWrite(1, ON, color, BOT);
  registerWrite(7, ON, color3, BOT);
  registerWrite(3, ON, color3, BOT);
  registerWrite(9, ON, color, BOT);
  delay(1000/4);
  registerWrite(5, OFF, color2, BOT);
  registerWrite(5, OFF, color3, BOT);
  registerWrite(1, OFF, color, BOT);
  registerWrite(7, OFF, color3, BOT);
  registerWrite(3, OFF, color3, BOT);
  registerWrite(9, OFF, color, BOT);
  x++;
  delay(1000/4);
  }
  else{
